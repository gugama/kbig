...
public class ChartMorphAnalyzer implements MorphAnalyzer {
	...
	public void initialize(String baseDir, String configFile) throws Exception {
		...
		fileDicSystem = "/temporary/hnn/data/kE/dic_system.txt";
		fileDicUser = "/temporary/hnn/data/kE/dic_user.txt";
		fileConnections = "/temporary/hnn/data/kE/connections.txt";
		fileConnectionsNot = "/temporary/hnn/data/kE/connections_not.txt";
		fileDicAnalyzed = "/temporary/hnn/data/kE/dic_analyzed.txt";
		fileTagSet = "/temporary/hnn/data/kE/tag_set.txt";
